...
var connToken="90939255|-31949288464514658|90940135";
...
function saveData(){
    ...
    var putRequest=createPUTRequest(connToken,jsonStrObj,empDB,empRelationName);
...
function changeData(){
    ...
    var updateRequest=createUPDATERecordRequest(connToken,jsonChange,empDB,empRelationName,parseInt($("#empid").val()));
    jQuery.ajaxSetup({async:false});
...
function resetData(){
    ...
    var getRequest=createGET_BY_RECORDRequest(connToken,empDB,empRelationName,localStorage.getItem("rec_no"));
    jQuery.ajaxSetup({async:false});
...
function getData(empIdJsonStr){
    var putReqStr=createGET_BY_KEYRequest(connToken,empDB,empRelationName,empIdJsonStr);
    jQuery.ajaxSetup({async:false});
...
function getFirst(){
    var getFirstRequest=createFIRST_RECORDRequest(connToken,empDB,empRelationName);
...
function getPrev(){
    ...
    var getPrevRequest=createPREV_RECORDRequest(connToken,empDB,empRelationName,rec);
    jQuery.ajaxSetup({async:false});
...
function getNext(){
    var rec=localStorage.getItem("rec_no");
    var getNextRequest=createNEXT_RECORDRequest(connToken,empDB,empRelationName,rec);
    jQuery.ajaxSetup({async:false});
...
function getLast(){
    var getLastRequest=createLAST_RECORDRequest(connToken,empDB,empRelationName);
    jQuery.ajaxSetup({async:false});
